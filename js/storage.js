...
const INITIAL_SEED_DATA = {
  ...
  notifications: [
    ...
    },
    {
      ...
      read: false,
      type: 'info',
      icon: '<i class="fa-solid fa-party-horn"></i>'
    },
    {
      id: 'NOTIF-3',
      title: 'Payment Received',
      message: 'Payment of PKR 255.00 for Neon Horizon Festival processed successfully.',
      time: '1 day ago',
      read: true,
      type: 'success',
  ...
  promos: [
    {
      ...
      discountValue: 20,
      description: '20% off all event admissions',
      active: true,
      minPurchase: 0
    },
    {
      ...
      discountType: 'fixed',
      discountValue: 50,
      description: 'PKR 50 flat discount on orders over PKR 150',
      active: true,
      minPurchase: 150
    },
    {
      ...
      discountType: 'percent',
      discountValue: 15,
      description: '15% Seasonal Summer Festival Discount',
      active: true,
      minPurchase: 50
    }
  ],
  reviews: [
    {
      ...
      userName: 'Sophia Martinez',
      rating: 5,
      comment: 'Mind-blowing audiovisual art installation! The venue was gorgeous and the digital pass QR scanned instantly at the gate.',
      date: '2026-07-20'
    },
    {
      id: 'REV-2',
      ...
      userName: 'Marcus Chen',
      rating: 5,
      comment: 'Superbly curated contemporary pieces. The acoustic lighting atmosphere was world-class.',
      date: '2026-07-22'
    },
    {
      id: 'REV-3',
      ...
      userName: 'Elena Rostova',
      rating: 5,
      comment: 'Incredible speaker lineup and networking opportunities! Cannot wait for the next edition.',
      date: '2026-08-10'
    }
  ],
  settings: {
